...
public class QueueFullAsyncLoggerConfigLoggingFromToStringTest extends QueueFullAbstractTest {
    ...
    public static void beforeClass() {
        ...
        System.setProperty(ConfigurationFactory.CONFIGURATION_FILE_PROPERTY, "log4j2-queueFullAsyncLoggerConfig.xml");
    }
    ...
    static void asyncLoggerConfigRecursiveTest(
            final Logger logger,
        ...
        assertEquals("Jumped the queue: queue full", "Logging in toString() #128", actual.pop());
        ...
        assertThat(
                mostRecentStatusData.getFormattedStatus(),
                containsString("Log4j2 logged an event out of order to prevent deadlock caused by domain "
