...
public final class Loader {
    ...
    static final Boolean ignoreTccl =
            PropertyEnvironment.getGlobal().getProperty(CoreKeys.Loader.class).ignoreTCL();
    ...
    /**
     * Loads a class by name. This method respects the {@link CoreKeys.Loader#ignoreTCL()} Log4j property. If this
     * property is
