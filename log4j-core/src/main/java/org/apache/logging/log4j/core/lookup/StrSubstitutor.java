...
public class StrSubstitutor implements ConfigurationAware {
    ...
    private int substitute(
        ...
        final ConverterKeysSubstitutor converterKeysSubstitutor = new ConverterKeysSubstitutor(this);
        ...
        while (pos < bufEnd) {
            ...
            if (pos > offset && chars[pos - 1] == escape) {
                ...
                while (pos < bufEnd) {
                    ...
                    // find ConverterKeys
                    pos = converterKeysSubstitutor.findCloseBracePosition(chars, pos, bufEnd);
