 ...
 */
public class SensitivePluginAttributeVisitor extends AbstractPluginVisitor<SensitivePluginAttribute> {
    ...
    public Object visit(final Configuration configuration, final Node node, final LogEvent event) {
        ...
        LOGGER.debug("Attribute({}=\"{}\"", name, NameUtil.md5(value + this.getClass().getName()));
        return value;
    }
}
