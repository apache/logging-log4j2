...
class AbstractByteBufferDestinationAppender<M extends ByteBufferDestinationManager> extends AbstractAppender {
    ...
    public AbstractByteBufferDestinationAppender(final String name, final Layout<? extends Serializable> layout,
