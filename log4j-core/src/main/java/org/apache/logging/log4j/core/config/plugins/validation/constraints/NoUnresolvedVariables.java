...
@Constraint(NoUnresolvedVariablesValidator.class)
public @interface NoUnresolvedVariables {

    /**
     * The message to be logged if this constraint is violated. This should normally be overridden.
     */
    String message() default "The parameter contains unresolved variables";
}
