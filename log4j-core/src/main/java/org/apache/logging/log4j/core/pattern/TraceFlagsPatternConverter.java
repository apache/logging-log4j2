...
public final class TraceFlagsPatternConverter extends LogEventPatternConverter {
    ...
    private static final TraceFlagsPatternConverter INSTANCE = new TraceFlagsPatternConverter();

    private TraceFlagsPatternConverter() {
        super("TraceFlags", "traceFlags");
    }

    public static TraceFlagsPatternConverter newInstance(final String[] options) {
        return INSTANCE;
    }
