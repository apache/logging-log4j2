...
public class FirstCircularBean {
    private final SecondCircularBean secondCircularBean;

    @Inject
    public FirstCircularBean(final SecondCircularBean secondCircularBean) {
        this.secondCircularBean = secondCircularBean;
    }
