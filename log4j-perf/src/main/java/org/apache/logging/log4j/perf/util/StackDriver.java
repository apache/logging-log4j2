...
public class StackDriver {
    public StackTraceElement deepCall(int initialDepth, final Integer targetDepth, final Function<String, StackTraceElement> supplier) {
        if (--initialDepth == 0) {
    ...
    public static class Processor implements BiFunction<Integer, Function<String, StackTraceElement>, StackTraceElement> {
        ...
        @Override
        public StackTraceElement apply(Integer depth, final Function<String, StackTraceElement> function) {
            if (--depth == 0) {
