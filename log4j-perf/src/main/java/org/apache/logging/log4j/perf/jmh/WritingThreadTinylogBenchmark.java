...
/**
 * Tests tinylog writering thread performance.
 */
// ============================== HOW TO RUN THIS TEST: ====================================
//
// single thread:
// java -jar log4j-perf/target/benchmarks.jar ".*WritingThreadTinylogBenchmark.*" -f 1 -wi 10 -i 20
//
// multiple threads (for example, 4 threads):
// java -jar log4j-perf/target/benchmarks.jar ".*WritingThreadTinylogBenchmark.*" -f 1 -wi 10 -i 20 -t 4 -si true
//
// Usage help:
// java -jar log4j-perf/target/benchmarks.jar -help
//
@State(Scope.Benchmark)
public class WritingThreadTinylogBenchmark {

    @Setup(Level.Trial)
    public void up() {
    	System.setProperty("tinylog.configuration", "tinylog-writing-thread-no-op-writer.properties");
    }
