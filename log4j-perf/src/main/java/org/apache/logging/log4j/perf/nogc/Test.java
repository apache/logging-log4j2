...
//            doTestRunBoth(classic, nogc, REPETITIONS, 0);
    ...
    private static void doTestRun(ClassicLogger logger, int repetitions, int n) {
        startTime[n] = System.currentTimeMillis();
        long start = System.nanoTime();
        for (int i = 0; i < repetitions; i++) {
    ...
    private static void doTestRunBoth(ClassicLogger classic, NoGcLogger nogc, int repetitions, int n) {
        startTime[n] = System.currentTimeMillis();
        long start = System.nanoTime();
        for (int i = 0; i < repetitions; i++) {
