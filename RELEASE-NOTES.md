...
The Log4j 2.12.2 API, as well as many core components, maintains binary compatibility with previous releases.
...
Apache Log4j 2.12.2 requires a minimum of Java 7 to build and run. Log4j 2.3 was the
