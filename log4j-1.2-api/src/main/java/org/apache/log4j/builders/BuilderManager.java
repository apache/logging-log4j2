...
public class BuilderManager {
    ...
    public TriggeringPolicy parseTriggeringPolicy(final String className, final Element policyElement,
            final XmlConfiguration config) {
        return newInstance(this.<TriggeringPolicyBuilder>getPlugin(className), b -> b.parse(policyElement, config),
