...
public class LoggingTest {
    ...
    public void testParent() {
        ...
        assertThat(parent).describedAs("No parent Logger").isNotNull();
        assertThat(parent.getName()).describedAs("Incorrect parent logger").isEqualTo("org.apache.test.logging");
    }
