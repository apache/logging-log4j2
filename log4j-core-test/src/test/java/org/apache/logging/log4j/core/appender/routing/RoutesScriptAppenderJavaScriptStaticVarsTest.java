...
public class RoutesScriptAppenderJavaScriptStaticVarsTest extends RoutesScriptAppenderTest {

    public RoutesScriptAppenderJavaScriptStaticVarsTest(LoggerContext context) {
        super(context, true);
    }
}
