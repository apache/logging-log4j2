...
public class RoutesScriptAppenderGroovyStaticVarsTest extends RoutesScriptAppenderTest {

    public RoutesScriptAppenderGroovyStaticVarsTest(LoggerContext context) {
        super(context, true);
    }
}
