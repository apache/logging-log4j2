...
public class ValidatingPluginWithTypedBuilderTest {
    ...
    public void setUp() throws Exception {
        ...
        final var plugin = pluginManager.getPluginType("ValidatingPluginWithTypedBuilder");
    ...
    public void testNullDefaultValue() throws Exception {
        final ValidatingPluginWithTypedBuilder validatingPlugin = injector.configure(node);
