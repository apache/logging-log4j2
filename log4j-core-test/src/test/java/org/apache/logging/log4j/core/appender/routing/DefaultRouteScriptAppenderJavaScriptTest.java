...
public class DefaultRouteScriptAppenderJavaScriptTest extends DefaultRouteScriptAppenderTest {
    public DefaultRouteScriptAppenderJavaScriptTest(LoggerContext context) {
        super(context, false);
    }
}
