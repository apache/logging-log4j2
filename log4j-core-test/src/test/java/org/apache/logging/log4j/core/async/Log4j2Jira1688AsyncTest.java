...
public class Log4j2Jira1688AsyncTest {
    ...
    @Test
    public void testLog4j2Only(@Named("List") final ListAppender listAppender, final ExtendedLogger logger) throws InterruptedException {
        ...
        logger.logIfEnabled("test", Level.ERROR, null, "test {}", args);
