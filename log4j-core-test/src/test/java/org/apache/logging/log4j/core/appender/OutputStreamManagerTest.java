...
public class OutputStreamManagerTest {
    ...
    public void narrow(final LoggerContext context) {
        ...
        assertEquals("Could not create plugin element RollingRandomAccessFile: org.apache.logging.log4j.core.config.ConfigurationException: Configuration has multiple incompatible Appenders pointing to the same resource 'target/multiIncompatibleAppender.log'",
