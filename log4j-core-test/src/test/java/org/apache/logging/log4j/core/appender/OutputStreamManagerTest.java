...
public class OutputStreamManagerTest {
    ...
    public void narrow(final LoggerContext context) {
        ...
        assertEquals(
                "Could not configure plugin element RollingRandomAccessFile: org.apache.logging.log4j.core.appender.ManagerException: Configuration has multiple incompatible Appenders pointing to the same resource 'target/multiIncompatibleAppender.log'",
