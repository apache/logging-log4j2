...
import static org.apache.logging.log4j.core.test.TestConstants.AUTH_BASIC_PASSWORD;
import static org.apache.logging.log4j.core.test.TestConstants.AUTH_BASIC_USERNAME;
import static org.apache.logging.log4j.core.test.TestConstants.CONFIGURATION_ALLOWED_PROTOCOLS;
 ...
 */
@WireMockTest
@SetTestProperty(key = CONFIGURATION_ALLOWED_PROTOCOLS, value = "jar,http")
class UrlConnectionFactoryTest {
    ...
    private final PropertyEnvironment environment = PropertyEnvironment.getGlobal();
    private final SslConfiguration sslConfiguration = SslConfigurationFactory.getSslConfiguration(environment);
    ...
    private int verifyNotModified(URI uri, long lastModifiedMillis) throws Exception {
        AuthorizationProvider authorizationProvider =
                AuthorizationProvider.getAuthorizationProvider(environment.getProperty(AuthenticationProperties.class));
        HttpURLConnection urlConnection = UrlConnectionFactory.createConnection(
