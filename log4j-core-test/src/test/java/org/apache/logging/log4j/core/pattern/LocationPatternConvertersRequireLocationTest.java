...
class LocationPatternConvertersRequireLocationTest {
    ...
    void testThatLocationDependentPatternConvertersIndicateLocationRequirement(final String converterKey)
        ...
        assertTrue(formatter.requiresLocation());
    }

    private PatternFormatter createSinglePatternFormatterFromConverterKey(final String converterKey) {
        final PatternParser parser = new PatternParser(ctx.getConfiguration(), KEY, null);
