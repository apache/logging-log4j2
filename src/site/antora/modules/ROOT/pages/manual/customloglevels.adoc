...
All logging implementation support filtering of log events, based on their log level, but the number of available log levels varies between implementations.
...
To ensure independence from a specific logging implementations you should restrict your log statements to **standard** log levels.
