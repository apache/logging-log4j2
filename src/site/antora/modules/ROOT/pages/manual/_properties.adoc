...
include::partial$properties-meta.adoc[]
...
include::partial$properties-loader-util.adoc[]
...
include::partial$properties-simple-logger.adoc[]
...
include::partial$properties-thread-context.adoc[]
...
include::partial$properties-context-selector.adoc[]
...
include::partial$properties-configuration-factory.adoc[]

=== Garbage Collection

include::partial$properties-garbage-collection.adoc[]
...
include::partial$properties-jansi.adoc[]

=== JMX

include::partial$properties-jmx.adoc[]
...
include::partial$properties-jndi.adoc[]
...
include::partial$properties-transport-security.adoc[]

=== Miscellaneous properties

include::partial$properties-log4j-core-misc.adoc[]

== JUL-to-Log4j API bridge

The JUL-to-Log4j API bridge provides the following configuration properties:

include::partial$properties-log4j-jul.adoc[]

== Log4j Spring Boot

The Log4j Spring Boot module supports the following configuration properties:

include::partial$properties-log4j-spring-boot.adoc[]
