...
For instance, we can use a xref:manual/filters.adoc#MarkerFilter[`MarkerFilter`] to redirect log events whose marker matches a particular name to a dedicated appender.
