...
[NOTE]
====
To prevent a chicken-and-egg problem some configuration options, such as the location of the configuration file can be supplied only through xref:manual/configuration/properties.adoc[System properties].
====
...
See xref:./configuration/properties.adoc#log4j2.configurationFile[log4j2.configurationFile] for details.
====
...
| Status | **DEPRECATED**
| Default value (since 2.24.0) | xref:./configuration/properties.adoc#log4j2.statusLoggerLevel[log4j2.statusLoggerLevel]
