...
You can use xref:manual/appenders/delegating.adoc#RewritePolicy[Rewrite Policy] to pre-process log event content for the purpose of, for example, masking sensitive information (such as PII) or injecting additional metadata.
