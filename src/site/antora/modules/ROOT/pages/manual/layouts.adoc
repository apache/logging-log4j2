...
* The link:https://docs.graylog.org/en/latest/pages/gelf.html#gelf[GELF specification]
...
NOTE: FIXME: log4j.dtd link is broken. Appends a series of `Event` elements as defined in the link:log4j.dtd[log4j.dtd].
