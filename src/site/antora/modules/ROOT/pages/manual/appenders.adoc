...
https://jakarta.ee/specifications/servlet/5.0/apidocs/jakarta/servlet/servletcontext#log(java.lang.String,java.lang.Throwable)[`ServletContext.log(String, Throwable)`]
methods.
...
<1> The appender passes the exception using the `Throwable` parameter of the
https://jakarta.ee/specifications/servlet/5.0/apidocs/jakarta/servlet/servletcontext#log(java.lang.String,java.lang.Throwable)[`ServletContext.log(String, Throwable)`] method.
Setting `alwaysWriteExceptions` to `false` prevents exceptions from appearing in the log file twice.
...
[CAUTION]
====
`ServletContext.log(String, Throwable)` is a very primitive logging interface.
Modern application servers usually forward its calls to a proper logging framework and use a **fixed** logging level for all the events.
====
