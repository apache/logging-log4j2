...
link:#NoSQLAppenderMongoDB[`MongoDb`] matching the current MongoDB Driver (version 5). This module tracks the current MongoDB Driver.

[#NoSQLAppenderMongoDB]
== NoSQLAppenderMongoDB for MongoDB
