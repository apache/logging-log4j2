...
|
| {log4j2-url}/manual/thread-context.adoc[]
...
| <<MapLookup,`map`>>
|
| {log4j2-url}/manual/messages.adoc#MapMessage[`MapMessage`]
...
|
| {log4j2-url}/manual/messages.adoc#StructuredDataMessage[`StructuredDataMessage`]
...
{log4j2-url}/manual/thread-context.adoc[ThreadContext]
to retrieve data.
+
[WARNING]
====
When used in this context
{log4j2-url}/manual/thread-context.adoc#custom-ContextDataProvider[custom context data providers]
are not supported.
====
...
{log4j2-url}/manual/thread-context.adoc#custom-ContextDataProvider[Custom context data providers] are therefore supported.
+
[TIP]
====
...
|Level
|{log4j2-url}/manual/customloglevels.adoc[Logging level] of the event

|Logger
|Name of the logger

|Marker
|{log4j2-url}/manual/markers.adoc[Marker] associated with the log event, if one is present.

|Message
|Formatted {log4j2-url}/manual/messages.adoc[`Message`]
