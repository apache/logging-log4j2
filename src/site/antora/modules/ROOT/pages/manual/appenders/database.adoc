...
| `true`
|
If `true`, values written to `CHAR`, `VARCHAR`, `NVARCHAR`, `LONGVARCHAR` and `LONGNVARCHAR` columns are silently truncated to the column precision reported by the JDBC driver.
