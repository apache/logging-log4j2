...
See also
xref:manual/systemproperties.adoc#log4j.transportSecurity.verifyHostName[`log4j.transportSecurity.verifyHostName`].
|===
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.location[`l.t.keyStore.location`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.password[`l.t.keyStore.password`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.passwordEnvVar[`l.t.keyStore.passwordEnvVar`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.passwordFile[`l.t.keyStore.passwordFile`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.type[`l.t.keyStore.type`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.keyStore.keyManagerFactory.algorithm[`l.t.keyStore.keyManagerFactory.algorithm`].
|===
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.location[`l.t.trustStore.location`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.password[`l.t.trustStore.password`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.passwordEnvVar[`l.t.trustStore.passwordEnvVar`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.passwordFile[`l.t.trustStore.passwordFile`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.type[`l.t.trustStore.type`].
...
See also xref:manual/systemproperties.adoc#log4j.transportSecurity.trustStore.keyManagerFactory.algorithm[`l.t.trustStore.keyManagerFactory.algorithm`].
|===
