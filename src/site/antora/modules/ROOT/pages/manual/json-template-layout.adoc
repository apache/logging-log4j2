...
See link:#map-resolver-template[] for details.
...
:plugin-extension-intro-component-name: JSON Template Layout
include::partial$manual/plugin-extension-intro.adoc[tag=part1]
...
* Recycler factories
include::partial$manual/plugin-extension-intro.adoc[tag=part2]
...
Though note that they are not garbage-free.
