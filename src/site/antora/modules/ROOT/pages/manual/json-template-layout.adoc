...
keyExcludes   = "keyExcludes" -> "[" , string , { "," , string } , "]"
...
`keyExcludes` allows specifying keys that should be excluded from the resolution process.
