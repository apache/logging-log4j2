...
is one of the principal Log4j components (see
xref:manual/architecture.adoc[]), which determines among other things, the way
link:../javadoc/log4j-api/org/apache/logging/log4j/Logger.html[Logger]s are created.
...
link:../javadoc/log4j-api/org/apache/logging/log4j/message/Message.html[Message]s can be customized using these properties:
...
link:../javadoc/log4j-kit/org/apache/logging/log4j/kit/env/PropertyEnvironment.html[PropertyEnvironment]
...
link:../javadoc/log4j-api/org/apache/logging/log4j/util/PropertiesUtil.html[PropertiesUtil]
service (see
