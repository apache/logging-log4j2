...
[source,xml]
----
include::example$configuration/scripts.xml[lines=1;18..-1]
----
...
[source,yaml]
----
include::example$configuration/scripts.yaml[lines=17..-1]
----
...
[source,properties]
----
include::example$configuration/scripts.properties[lines=17..-1]
----
====
