...
<2> Rethrowing the exception, contrary to <<example-catching,the `catching()` example>> suppressing the exception
...
[source,xml]
----
include::example$manual/flowtracing/log4j2.xml[lines=24..41,indent=0]
----
...
[source,xml]
----
include::example$manual/flowtracing/log4j2.json[lines=4..40,indent=0]
----
...
[source,xml]
----
include::example$manual/flowtracing/log4j2.yaml[lines=19..40,indent=0]
----
...
[source,xml]
----
include::example$manual/flowtracing/log4j2.properties[lines=18..35,indent=0]
----
====
