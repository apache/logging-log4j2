...
[source,xml]
----
include::example$configuration/filters.xml[lines=1;18..-1]
----
...
[source,yaml]
----
include::example$configuration/filters.yaml[lines=17..-1]
----
...
[source,properties]
----
include::example$configuration/filters.properties[lines=17..-1]
----
====
...
LogEvents are processed by silently discarding events after the maximum limit has been reached.
...
is added to the configuration as a filter element and contains other
filters to be evaluated. The filter element accepts no parameters.
