...
. Logback accepts It is highly likely that you were routing all foreign logging APIs to Logback (you or some of your (direct or transitive) dependencies using SLF4J too.
