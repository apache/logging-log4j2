...
To use it, you need to set the xref:manual/systemproperties.adoc#log4j.message.factory[`log4j.message.factory`] configuration property to `org.apache.logging.slf4j.message.ThrowableConsumingMessageFactory`.
====
