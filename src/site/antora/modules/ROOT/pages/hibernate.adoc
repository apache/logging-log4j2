...
[source,xml]
----
include::example$hibernate/log4j2.xml[lines=30..38,indent=0]
----
...
[source,xml]
----
include::example$hibernate/log4j2.json[lines=9..32,indent=0]
----
...
[source,xml]
----
include::example$hibernate/log4j2.yaml[lines=24..38,indent=0]
----
...
[source,xml]
----
include::example$hibernate/log4j2.properties[lines=21..31]
----
====
...
https://stackoverflow.com/q/73734494/1278899[Combining `hibernate.show_sql` with logger-based configuration duplicates the logging effort.]
====
