...
** xref:compatibility-breaks.adoc[]
...
** xref:architecture-overview.adoc[Modernization architecture]
...
*** xref:modernization-performance-validation.adoc[]
...
* xref:manual/migration-spring-boot-3.adoc[]
* xref:architecture-overview.adoc[]
* xref:trustgate.adoc[]
* xref:graalvm.adoc[]
* xref:hibernate.adoc[]
* xref:jakarta.adoc[]
* xref:manual/jakarta-migration.adoc[]
* xref:soa.adoc[]
