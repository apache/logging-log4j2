...
* Update `co.elastic.clients:elasticsearch-java` to version `8.11.1` (https://github.com/apache/logging-log4j2/pull/1968[1968])
...
* Update `github/codeql-action` to version `2.22.6` (https://github.com/apache/logging-log4j2/pull/1971[1971])
