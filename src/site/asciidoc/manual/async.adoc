...
|[[log4j2.asyncLoggerWaitStrategy]]log4j2.asyncLoggerWaitStrategy
|`Timeout`
|Valid values: Block,
Timeout, Sleep, Yield.
...
link:#log4j2.asyncLoggerWaitStrategy[WaitStrategy System Property] for details.
...
|[[log4j2.asyncLoggerConfigWaitStrategy]]log4j2.asyncLoggerConfigWaitStrategy
|`Timeout`
|Valid values: Block,
Timeout, Sleep, Yield. +
`Block` is a strategy that uses a lock and condition variable for the
...
|`10`
|Timeout in milliseconds of `TimeoutBlockingWaitStrategy`. See
link:#log4j2.asyncLoggerConfigWaitStrategy[WaitStrategy System Property] for details.
