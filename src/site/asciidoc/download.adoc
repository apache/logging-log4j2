...
To keep your Log4j module versions in sync with each other, a  <abbr id="Bill of Material">BOM</abbr>
pom.xml file is provided for your convenience. To use this with [Maven](https://maven.apache.org/),
