...
public final class ProviderUtil {
    ...
    private ProviderUtil() {
        ServiceLoaderUtil.safeStream(ServiceLoader.load(Provider.class, ProviderUtil.class.getClassLoader()))
    ...
    static void loadProviders(final ClassLoader classLoader) {
        ServiceLoaderUtil.safeStream(ServiceLoader.load(Provider.class, classLoader))
                .filter(provider -> validVersion(provider.getVersions()))
                .forEach(PROVIDERS::add);
    }
