...
public class DefaultThreadContextMap implements ThreadContextMap, ReadOnlyStringMap {
    ...
    public DefaultThreadContextMap(final boolean useMap) {
        this(useMap, PropertiesUtil.getProperties().getBooleanProperty(INHERITABLE_MAP));
    }

    private DefaultThreadContextMap(final boolean useMap, final boolean inheritableMap) {
        this.useMap = useMap;
