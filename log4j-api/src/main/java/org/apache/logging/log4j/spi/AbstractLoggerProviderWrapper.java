 ...
 */
public class AbstractLoggerProviderWrapper extends AbstractLoggerProvider {
     ...
     */
    public AbstractLoggerProviderWrapper(final LoggerProvider logger, final String name, final MessageFactory messageFactory) {
