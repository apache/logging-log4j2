...
public class LogManager {
    ...
    public static LoggerContext getContext(
        ...
        try {
            ...
            return new SimpleLoggerContextFactory()
                    .getContext(FQCN, loader, null, currentContext, configLocation, null);
        }
    }
    ...
    public static LoggerContext getContext(
        ...
        try {
            ...
            LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return new SimpleLoggerContextFactory()
                    .getContext(FQCN, loader, externalContext, currentContext, configLocation, null);
        }
    }
    ...
    public static LoggerContext getContext(
        ...
        try {
            ...
            LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return new SimpleLoggerContextFactory()
                    .getContext(FQCN, loader, externalContext, currentContext, configLocation, name);
        }
    }
