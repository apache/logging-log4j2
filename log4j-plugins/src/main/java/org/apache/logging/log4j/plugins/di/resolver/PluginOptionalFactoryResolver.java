 ...
 */
public class PluginOptionalFactoryResolver extends AbstractPluginFactoryResolver {
    @Override
    ...
    public Supplier<?> getFactory(final ResolvableKey<?> resolvableKey, final InstanceFactory instanceFactory) {
        ...
        return () -> Plugins.streamPluginsMatching(instanceFactory, namespace, componentType).findFirst();
    }
}
