...
public interface Scope {
    ...
    /**
     * Scopes an instance factory for the provided key and unscoped factory in this scope. The scoped factory
     * should return a current scoped instance or create a new one using the unscoped factory.
     */
