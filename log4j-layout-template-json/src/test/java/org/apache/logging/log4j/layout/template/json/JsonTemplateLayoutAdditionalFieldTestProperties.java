...
class JsonTemplateLayoutAdditionalFieldTestProperties {
    ...
    @Test
    void test_array_with_properties(final LoggerContext loggerContext,  @Named("List") final ListAppender appender){
        // Log an event.
        final Logger logger =
                loggerContext.getLogger(
                        JsonTemplateLayoutAdditionalFieldTestProperties.class);
        logger.info("trigger");
