...
public class Log4jBridgeHandlerTest {
    ...
    private String jul(
            java.util.logging.Level lvl, String locationPartRE, String msgPartRE, String exceptionClassAndMsgRE) {
    ...
    public void test5LevelPropGC() {
        ...
        java.util.logging.Logger julLogRef =
